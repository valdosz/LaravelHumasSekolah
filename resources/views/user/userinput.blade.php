...
@section('content')
			...
			<form action="{{ url('simpan') }}" method="post">
				...
				<div class="card-body">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<label>No Hp</label>
							<input type="number" name="kontak" class="form-control" autocomplete="off" required placeholder="Example : 0895804176117">
						</div>
						<div class="form-group">
							<label>Tujuan</label>
	...
	<script>
        $('.btnSimpan').click(function(){
            swal("Berhasil Simpan","{{ session('message') }}",'success');
        });
    </script>
	<div class="col-sm-12">
        @if($errors->any())
